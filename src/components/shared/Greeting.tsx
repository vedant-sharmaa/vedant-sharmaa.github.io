  ...
  return (
    <div>
      <p className="font-light text-justify">
        ...
        <strong>Artificial Intelligence</strong> and <strong>Systems Research.
        </strong> My journey spans {' '}<strong>full-stack development</strong>,
        <strong> cloud computing</strong>, <strong>deep learning</strong>, and <strong>freelancing</strong>, 
